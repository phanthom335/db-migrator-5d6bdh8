        ...
        Db Migrator 5d6bdh8
        ===================
        Open-source data utility that cleans tabular data across multiple formats.
...
def _write_output(rows: list, path: Path, suffix: str) -> None:
    ...
    if suffix == ".csv" and rows:
        ...
        def build_parser() -> argparse.ArgumentParser:
            p = argparse.ArgumentParser(prog=APP_NAME, description="Open-source data utility that cleans tabular data across multiple formats.")
